...
## Solution
Inspeccionando el codigo fuente de la pagina nos damos cuenta de algunas subcarpetas o subligas que nos llevan a al objetivo, en este caso se encuentra "secret"
...
ingresando a http://saturn.picoctf.net:52025/secret/hidden/superhidden
``` html 
<!DOCTYPE html>
<html>
  <head>
