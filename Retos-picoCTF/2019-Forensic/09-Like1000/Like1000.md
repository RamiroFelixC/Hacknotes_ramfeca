...
## Solución
``` bash
┌─[ramdark@parrot]─[~/Documents/Hacking_Notes_RFC/Retos-picoCTF/2019-Forensic/09-Like1000]
└──╼ $ls
1000.tar  Like1000.md
┌─[ramdark@parrot]─[~/Documents/Hacking_Notes_RFC/Retos-picoCTF/2019-Forensic/09-Like1000]
└──╼ $tar -tf 1000.tar 
999.tar
filler.txt
...
┌─[ramdark@parrot]─[~/Documents/Hacking_Notes_RFC/Retos-picoCTF/2019-Forensic/09-Like1000]
└──╼ $ls
1000.tar  Like1000.md  script.py
┌─[ramdark@parrot]─[~/Documents/Hacking_Notes_RFC/Retos-picoCTF/2019-Forensic/09-Like1000]
└──╼ $python3 script.py 
┌─[ramdark@parrot]─[~/Documents/Hacking_Notes_RFC/Retos-picoCTF/2019-Forensic/09-Like1000]
└──╼ $ls
...
209.tar   322.tar  436.tar  54.tar   663.tar  777.tar  890.tar  script.py
