...
|Comando | Descripcion |
|------------ | ------------|
|myname=bandit23 |nos ayuda a darle valores a una variable en lenguaje bash |
|md5sum| genera una cadena de caracteres hash|
|cut -d '' -f 1| quita un guión medio al final de la cadena|
