...
Starting Nmap 7.80 ( https://nmap.org ) at 2023-02-22 19:20 UTC
...
└──╼ $ls
Hacking_Notes_RFC  llave.txt  millave.txt
┌─[ramdark@parrot]─[~/Documents]
└──╼ $chmod 600 llave.txt
┌─[ramdark@parrot]─[~/Documents]
...
|open ssl |comando que genera llaves privadas, CSRs e identificar certificados|
