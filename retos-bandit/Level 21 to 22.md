...
|Comando | Descripcion |
|------------ | ------------|
|cron | inicia automaticamente procesos y  los ejecuta segun su programación, es decir, por intervalos de tiempo, suelen estar en /etc/cron.d|

cronjob: los asteriscos definen cuando se ejecutara 
minuto 
hora
dia mes
mes 
